...

{
  ...
  return (
    ...
    >
      <div className="max-w-screen-xl mt-10 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-2 mx-auto text-slate-50 rounded-lg shadow-lg">
        <div className="pb-8">
